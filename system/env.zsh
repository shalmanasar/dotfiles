...
export M2_HOME=$(readlink /usr/local/bin/mvn)
export M3_HOME=$M2_HOME
export M3=$M3_HOME/bin
export MAVEN_HOME=$M2_HOME
export MVN_HOME=$M2_HOME/libexec
##BAD## export GEM_PATH=/Library/Ruby/Gems/2.3.0:/Users/scarpenter/.gem/ruby/2.4.0:/System/Library/Frameworks/Ruby.framework/Versions/2.3/usr/lib/ruby/gems/2.3.0
...
export ADB_PATH="/Users/scarpenter/android-sdks/platform-tools"
...
export NODE_PATH=$NODE_PATH:/Users/scarpenter/.node/lib/node_modules
...
# Boot2Docker
### restore for production ###export DOCKER_HOST=tcp://$(boot2docker ip 2>/dev/null):2375

# carina
export CARINA_USERNAME=src@shalmanasar.com
export CARINA_APIKEY=58ea0900cc8b4c38b16978a4cc263da6
